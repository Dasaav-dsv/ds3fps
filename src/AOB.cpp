...
extern void PopulateBases()
{
    ...
    const unsigned char SprjFlipperMatch[] = { 0xC6, 0x80, 0x80, 0x00, 0x00, 0x00, 0x01, 0x48, 0x8B, 0x05 };
    const unsigned char SprjRemoMatch[] = { 0x48, 0x85, 0xC0, 0x74, 0x0, 0x80, 0xB8, 0x0, 0x0, 0x0, 0x0, 0x00, 0x0F, 0xB6, 0xDB, 0x0F, 0x45, 0xDF, 0x48, 0x8B, 0x0D };
    const unsigned char SprjEventFlagManMatch[] = { 0x48, 0x8B, 0x0D, 0x0, 0x0, 0x0, 0x0, 0x44, 0x0F, 0xB6, 0xCB, 0x41, 0xB8, 0x07, 0x00, 0x00, 0x00, 0x8B, 0xD6 };
    ...
    const unsigned char SoloParamRepositoryMatch[] = { 0x48, 0x89, 0x5C, 0x24, 0x48, 0x8B, 0xFA, 0x48, 0x8B, 0xD9, 0xC7, 0x44, 0x24, 0x20, 0x00, 0x00, 0x00, 0x00, 0x48 };
    ...
    const unsigned char MagicPtrMatch[] = { 0x4C, 0x8D, 0x3D, 0x0, 0x0, 0x0, 0x0, 0x48, 0x8D, 0x34, 0x45, 0x01, 0x00, 0x00, 0x00 };

    const unsigned char GenInputPtrAOBMatch[] = { 0x48, 0x8D, 0x54, 0x24, 0x70, 0xE8, 0x0, 0x0, 0x0, 0x0, 0x48, 0x8B, 0x9C, 0x24, 0x80, 0x00, 0x00, 0x00 };
    const unsigned char BoneOffsetBasePointerAOBMatch[] = { 0x48, 0x8D, 0x05, 0x0, 0x0, 0x0, 0x0, 0x48, 0x89, 0x43, 0x28, 0x33, 0xC0, 0x89, 0x87, 0x0, 0x0, 0x0, 0x0, 0x48, 0x8D, 0x9F };
    ...
    const char* BoneOffsetBasePointerAOBMask = "...????........????...";
    ...
    BoneOffsetBasePointerAOB = reinterpret_cast<char*>(AOBScanBase(BoneOffsetBasePointerAOBMatch, BoneOffsetBasePointerAOBMask, 0x2A, 0x3));
}
...
extern void ScanAOBs()
{
    ...
    const unsigned char BOBP_CallAOBMatch[] = { 0x48, 0x8B, 0x01, 0x48, 0x8D, 0x91, 0x00, 0x01, 0x00, 0x00, 0x48, 0xFF, 0xA0, 0xF0, 0x00, 0x00, 0x00 };
    ...
    const unsigned char StrafeCheckAOB1Match[] = { 0x40, 0x88, 0xBB, 0xC1, 0x02, 0x00, 0x00, 0x48, 0x8B, 0x5C, 0x24, 0x30, 0x48, 0x83, 0xC4, 0x20, 0x5F, 0xC3 };
    const unsigned char StrafeCheckAOB2Match[] = { 0x40, 0x88, 0xB9, 0xC1, 0x02, 0x00, 0x00, 0x48, 0x8B, 0x5C, 0x24, 0x30, 0x48, 0x83, 0xC4, 0x20, 0x5F, 0xC3 };
    const unsigned char GetTAEAOBMatch[] = { 0x48, 0x85, 0xFF, 0x74, 0x5B, 0x48, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x48, 0x85, 0xC9, 0x75, 0x26 };
    const unsigned char GenMsgCodeAOBMatch[] = { 0xB9, 0x3E, 0x00, 0x00, 0x00, 0xE8, 0x0, 0x0, 0x0, 0x0, 0x41, 0xFF, 0xC7 };
    const unsigned char FallDeathCodeAOBMatch[] = { 0xC6, 0x80, 0x90, 0x00, 0x00, 0x00, 0x01, 0xE9, 0x0, 0x0, 0x00, 0x00, 0x48 };
    const unsigned char HeadSizeCodeAOBMatch[] = { 0x48, 0x8B, 0x41, 0x50, 0x48, 0x63, 0xD2, 0xF3, 0x0F, 0x10, 0x44, 0x90, 0x08 };
    const unsigned char UpperHandCodeAOBMatch[] = { 0x8B, 0xB0, 0x24, 0x01, 0x00, 0x00 };
    const unsigned char CamSensCodeAOBMatch[] = { 0xF3, 0x0F, 0x10, 0x96, 0x80, 0x02, 0x00, 0x00, 0xF3, 0x0F, 0x59, 0xD2 };
    const unsigned char MenuValCodeAOBMatch[] = { 0x8B, 0x93, 0xC8, 0x0B, 0x00, 0x00, 0xE8 };
    const unsigned char StartScreenHookAOBMatch[] = { 0x48, 0x8B, 0x59, 0x08, 0x48, 0x8B, 0xF9, 0x48, 0x8D, 0x8B, 0xE0, 0x09, 0x00, 0x00 };
    const unsigned char HkRunCodeAOBMatch[] = { 0xFF, 0x50, 0x0, 0x48, 0x8B, 0xCF, 0x0F, 0xB7, 0xD0 };
    const unsigned char RunStateCodeAOBMatch[] = { 0x83, 0x8F, 0x2C, 0x01, 0x00, 0x00, 0x04, 0x45, 0x84, 0xFF };
    const unsigned char AimFadeCodeAOBMatch[] = { 0x0F, 0x2F, 0xCF, 0x48, 0x0F, 0x46, 0xC1, 0x8B, 0x00, 0x89, 0x87 };
    ...
    const unsigned char CamCodeAOB08Match[] = { 0x4C, 0x8D, 0x45, 0x50, 0x48, 0x8B, 0xD3, 0x48, 0x8D, 0x8D, 0x0, 0x0, 0x0, 0x0, 0xE8, 0x0, 0x0, 0x0, 0x0, 0x0F, 0x28, 0x00, 0x66, 0x0F, 0x7F, 0x03, 0x0F, 0x28, 0x48, 0x10, 0x66, 0x0F, 0x7F, 0x4B, 0x10 };
    ...
    const unsigned char CamCodeAOB19Match[] = { 0xF3, 0x0F, 0x11, 0x4E, 0x50, 0x4C, 0x89, 0xB5, 0xA0, 0x12, 0x00, 0x00 };
    const unsigned char CamCodeAOB20Match[] = { 0x44, 0x88, 0x7C, 0x24, 0x20, 0xE8, 0x0, 0x0, 0x0, 0x0, 0x0F, 0x28, 0xB4, 0x24, 0xA0, 0x00, 0x00, 0x00 };
    const unsigned char CamCodeAOB21Match[] = { 0xBA, 0x01, 0x00, 0x00, 0x00, 0x48, 0x8B, 0xCF, 0xE8, 0x0, 0x0, 0x0, 0x0, 0x48, 0x8D, 0x53, 0x10, 0x48, 0x8B, 0xCF };
    const unsigned char CamCodeAOB22Match[] = { 0x66, 0x0F, 0x7F, 0x4B, 0x10, 0x0F, 0x28, 0x8B, 0x80, 0x00, 0x00, 0x00 };
    const unsigned char CamCodeAOB26Match[] = { 0x44, 0x0F, 0x29, 0x43, 0x40, 0xF3, 0x0F, 0x10, 0x83, 0xF8, 0x00, 0x00, 0x00 };

    const unsigned char GetEventFlagAOBMatch[] = { 0x40, 0x53, 0x48, 0x83, 0xEC, 0x0, 0x80, 0xB9, 0x0, 0x0, 0x0, 0x0, 0x00, 0x8B, 0xDA };
    const unsigned char SetEventFlagAOBMatch[] = { 0x40, 0x55, 0x57, 0x41, 0x54, 0x41, 0x57, 0x48, 0x83, 0xEC, 0x0, 0x80, 0xB9, 0x0, 0x0, 0x0, 0x0, 0x00, 0x45, 0x0F, 0xB6, 0xF9, 0x45, 0x0F, 0xB6, 0xE0 };

    const char* LockOnCodeAOBMask = ".?...????.....";
    const char* LOC_CallAOBMask = "...????......????......?....";
    const char* BOBP_CallAOBMask = ".................";
    ...
    BOBP_CallAOB = AOBScanCode(BOBP_CallAOBMatch, BOBP_CallAOBMask);
    ...
    GenMsgCodeAOB = AOBScanCode(GenMsgCodeAOBMatch, GenMsgCodeAOBMask);
    FallDeathCodeAOB = AOBScanCode(FallDeathCodeAOBMatch, FallDeathCodeAOBMask, 0x11);
