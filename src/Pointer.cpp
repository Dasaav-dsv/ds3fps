...
extern PDATA MenuStatePtr[] = { &WorldChrMan, 0x80, 0x50, 0x110, 0x418 };
extern PDATA ObjActStatePtr[] = { &WorldChrMan, 0x80, 0x50, 0x183 };
extern PDATA RunPressStatePtr[] = { &WorldChrMan, 0x80, 0x50, 0x110, 0x411 };
...
extern PDATA BoneOffsetPtr[] = { &BoneOffsetBasePointer, 0x50, 0x20, 0x38, 0x20, 0x0 };
...
extern PDATA HeadBonePosPtr[] = { &FrpgHavokMan, 0x38, 0x8, 0xE0, 0 };
extern PDATA HeadBoneQPtr[] = { &FrpgHavokMan, 0x38, 0x8, 0xE0, 0 };

extern PDATA MouseInputLRPtr[] = { &UserInputManager, 0x18, 0x8, 0x150, 0 };
extern PDATA MouseInputUDPtr[] = { &UserInputManager, 0x18, 0x8, 0x150, 0 };
extern PDATA MouseSensPtr[] = { &CSPcKeyConfig, 0x710 };

extern PDATA RStickInputLRPtr[] = { &UserInputManager, 0x18, 0x8, 0x150, 0 };
extern PDATA RStickInputUDPtr[] = { &UserInputManager, 0x18, 0x8, 0x150, 0 };
extern PDATA PadSensPtr[] = { &FieldArea, 0x28, 0x60, 0x280 };

extern PDATA MovementInputLRPtr[] = { &UserInputManager, 0x18, 0x8, 0x150, 0 };
extern PDATA MovementInputUDPtr[] = { &UserInputManager, 0x18, 0x8, 0x150, 0 };
